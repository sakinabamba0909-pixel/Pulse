    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          background: 'rgba(42,45,53,0.08)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)',
      ...
      <div style={{
        ...
        <div style={{ flex: 1, padding: '16px 24px 24px', display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <input
            ...
            style={{
              border: 'none', borderBottom: '1.5px solid rgba(255,255,255,0.30)', outline: 'none',
