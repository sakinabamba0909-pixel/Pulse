    ...
    >
      ...
      <div
        ...
        style={{
          ...
          border: `1.5px solid ${isSelected ? '#9B7EC8' : hovered ? 'rgba(155,126,200,0.4)' : 'rgba(155,126,200,0.25)'}`,
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 4, flexWrap: 'wrap' }}>
          ...
          {task.scheduled_start && (() => {
            ...
            return (
              <span style={{ fontSize: 11, color: '#5C5650', fontFamily: "'Outfit', sans-serif", background: 'rgba(255,255,255,0.45)', padding: '1px 6px', borderRadius: 6 }}>
                🗓 {day} {fmt(s)}{e ? `–${fmt(e)}` : ''}
              </span>
            )
          })()}
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 24, flexWrap: 'wrap' }}>
      {filters.map(f => (
        <button key={f.key} onClick={() => onFilter(f.key)} style={{
          ...
          background: filter === f.key ? 'rgba(155,126,200,0.10)' : 'rgba(255,255,255,0.45)',
      ...
      <select
        ...
        style={{
          ...
          background: 'rgba(255,255,255,0.45)', outline: 'none', cursor: 'pointer',
        }}
      >
      ...
      {isSelectionMode && (() => {
        ...
        return (
          <div style={{
            ...
            boxShadow: '0 8px 32px rgba(155,126,200,0.25)',
            fontFamily: "'Outfit', sans-serif",
