...
export default function Orb({ size = 120, animate = true, dark = false }: OrbProps) {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      g1.addColorStop(0, dark ? 'rgba(155,126,200,0.15)' : 'rgba(212,168,200,0.7)');
      g1.addColorStop(0.5, dark ? 'rgba(155,126,200,0.08)' : 'rgba(155,126,200,0.5)');
      g1.addColorStop(1, 'rgba(0,0,0,0)');
      ctx.fillStyle = g1;
      ctx.shadowBlur = 12;
      ctx.shadowColor = 'rgba(155,126,200,0.25)';
      ctx.beginPath();
      ...
      for (let i = 0; i < 3; i++) {
        ...
        ctx.strokeStyle = dark
          ? `rgba(155,126,200,${0.18 - i * 0.04})`
          : `rgba(155,126,200,${0.15 - i * 0.04})`;
        ctx.lineWidth = 1;
        ctx.beginPath();
      ...
      cg.addColorStop(0, '#D4849A');
      cg.addColorStop(1, '#9B7EC8');
      ctx.fillStyle = cg;
      ctx.beginPath();
