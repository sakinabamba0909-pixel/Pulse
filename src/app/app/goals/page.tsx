...
export default async function GoalsPage() {
  ...
  return (
    <div style={{ padding: '64px 40px', fontFamily: "'Outfit', sans-serif", color: '#2D2A26' }}>
      <p style={{ fontSize: 12, color: '#9E958B', marginBottom: 8, letterSpacing: 0.2 }}>Goals</p>
      ...
      {goals && goals.length > 0 ? (
          ...
          {goals.map(g => {
            ...
            return (
              <div key={g.id} style={{
                ...
                <p style={{ fontSize: 15, fontWeight: 600, color: '#2D2A26', marginBottom: 4 }}>{meta.label}</p>
                <p style={{ fontSize: 13, color: '#9E958B', lineHeight: 1.5 }}>{g.title}</p>
                <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: 16, fontWeight: 500, color: '#2D2A26', marginBottom: 6 }}>No goals yet</p>
