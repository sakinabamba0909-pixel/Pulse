    ...
    <div style={{ padding: '64px 40px', fontFamily: "'DM Sans', sans-serif", color: '#1A1A1A' }}>
      ...
      {goals && goals.length > 0 ? (
          ...
          {goals.map(g => {
            ...
            return (
              <div key={g.id} style={{
                ...
                <p style={{ fontSize: 15, fontWeight: 600, color: '#1A1A1A', marginBottom: 4 }}>{meta.label}</p>
                <p style={{ fontSize: 13, color: '#8A949E', lineHeight: 1.5 }}>{g.title}</p>
                <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: 16, fontWeight: 500, color: '#1A1A1A', marginBottom: 6 }}>No goals yet</p>
