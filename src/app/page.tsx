      ...
      <header className="border-b border-[#232A33] bg-[#0a0a0a]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            <a href="/review" className="text-sm text-[#8B95A3] hover:text-[#6EE7A0] transition-colors">
              Review
            </a>
            <a href="/progress" className="text-sm text-[#8B95A3] hover:text-[#6EE7A0] transition-colors">
              Progress
            </a>
          </nav>
        </div>
